...
class DevSeeder extends Seeder
{
    ...
    public function run(): void
    {
         ...
         */
        $customers = [
            ['customer_code' => 'customer-001', 'customer_name' => 'PT ABC'],
            ['customer_code' => 'customer-002', 'customer_name' => 'PT DEF'],
            ['customer_code' => 'customer-003', 'customer_name' => 'PT GHI'],
        ];
         ...
         */
        $suppliers = [
            ['supplier_code' => 'supplier-001', 'supplier_name' => 'PT JKL'],
            ['supplier_code' => 'supplier-002', 'supplier_name' => 'PT MNO'],
            ['supplier_code' => 'supplier-003', 'supplier_name' => 'PT PQR'],
        ];
